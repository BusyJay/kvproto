...
func (*BatchCommandsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_9499abda0c8188cc, []int{0}
}
...
func (*BatchCommandsRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_9499abda0c8188cc, []int{0, 0}
}
...
func (*BatchCommandsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_9499abda0c8188cc, []int{1}
}
...
func (*BatchCommandsResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_9499abda0c8188cc, []int{1, 0}
}
...
func (*BatchRaftMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_9499abda0c8188cc, []int{2}
}
...
type TikvClient interface {
	...
	BatchRaft2(ctx context.Context, opts ...grpc.CallOption) (Tikv_BatchRaft2Client, error)
...
func (c *tikvClient) BatchRaft2(ctx context.Context, opts ...grpc.CallOption) (Tikv_BatchRaft2Client, error) {
	stream, err := c.cc.NewStream(ctx, &_Tikv_serviceDesc.Streams[3], "/tikvpb.Tikv/BatchRaft2", opts...)
	if err != nil {
		return nil, err
	}
	x := &tikvBatchRaft2Client{stream}
	return x, nil
}

type Tikv_BatchRaft2Client interface {
	Send(*raft_serverpb.BatchRaftMessage2) error
	CloseAndRecv() (*raft_serverpb.Done, error)
	grpc.ClientStream
}

type tikvBatchRaft2Client struct {
	grpc.ClientStream
}

func (x *tikvBatchRaft2Client) Send(m *raft_serverpb.BatchRaftMessage2) error {
	return x.ClientStream.SendMsg(m)
}

func (x *tikvBatchRaft2Client) CloseAndRecv() (*raft_serverpb.Done, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(raft_serverpb.Done)
...
type TikvServer interface {
	...
	BatchRaft2(Tikv_BatchRaft2Server) error
...
func _Tikv_BatchRaft2_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TikvServer).BatchRaft2(&tikvBatchRaft2Server{stream})
}

type Tikv_BatchRaft2Server interface {
	SendAndClose(*raft_serverpb.Done) error
	Recv() (*raft_serverpb.BatchRaftMessage2, error)
	grpc.ServerStream
}

type tikvBatchRaft2Server struct {
	grpc.ServerStream
}

func (x *tikvBatchRaft2Server) SendAndClose(m *raft_serverpb.Done) error {
	return x.ServerStream.SendMsg(m)
}

func (x *tikvBatchRaft2Server) Recv() (*raft_serverpb.BatchRaftMessage2, error) {
	m := new(raft_serverpb.BatchRaftMessage2)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var _Tikv_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "BatchRaft2",
			Handler:       _Tikv_BatchRaft2_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "Snapshot",
...
func init() { proto.RegisterFile("tikvpb.proto", fileDescriptor_tikvpb_9499abda0c8188cc) }

var fileDescriptor_tikvpb_9499abda0c8188cc = []byte{
	...
	,
}
